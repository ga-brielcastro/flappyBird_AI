...
BACKGROUND_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'pipe.png')))
PASSARO_IMGS = [
...
class Passaro:
    ...
    def desenhar(self, tela):
        # definir qual mm do passaro vai usar
...
class Chao:
    ...
    def __init__(self, y):
        self.y = y
        self.x1 = 0
        self.x2 = self.LARGURA  # não vou precisar somar com x1 (chão 1) pois é zerio

    def mover(self):
        self.x1 -= self.VELOCIDADE
        self.x2 -= self.VELOCIDADE

        if self.x1 + self.LARGURA < 0:  # porque saiu da tela
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    texto = FONTE_PONTOS.render(f'Pontuaçao: {pontos}', 1, (255, 255, 255))
...
def main():
    ...
    rodando = True
    while rodando:
        relogio.tick(30)  # frames por segundo - vai controlar o tempo do nosso jogo
